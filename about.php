                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-12 col-lg-6 mb-8 mb-lg-0">
                                <div>
                                    ...
                                    <h2 class="font-w-6">درباره پروژه</h2>
                                </div>
                                <lottie-player
                                    ...
                                    <div class="accordion-item border-0 py-3 rounded-4 mb-4">
                                        <h3 class="accordion-header" id="heading1">
                                            <button
                                                ...
                                                aria-expanded="true" aria-controls="collapse1"> طراح و برنامه نویس
                                            </button>
                                        </h3>
                                        <div id="collapse1" class="accordion-collapse border-0 collapse show"
                                            aria-labelledby="heading1" data-bs-parent="#accordion">
                                            <div class="accordion-body pt-0 text-muted">مریم لطفی</div>
                                        </div>
                                    </div>
                                    <div class="accordion-item border-0 py-3 rounded-4 mb-4">
                                        <h3 class="accordion-header" id="heading5">
                                            <button
                                                ...
                                                aria-expanded="true" aria-controls="collapse5"> اطلاعات تماس
                                            </button>
                                        </h3>
                                        <div id="collapse5" class="accordion-collapse border-0 collapse show"
                                            aria-labelledby="heading5" data-bs-parent="#accordion">
                                            <div class="accordion-body pt-0 text-muted">
                                                <ul class="media-icon list-unstyled">
                                                    <li class="mb-2">
                                                        <a class="h6" href="mailto:mary.2002.lotfi@gmail.com">
                                                            mary.2002.lotfi@gmail.com</a>
                                                    </li>
                                                    <li>
                                                        <a class="h6" href="tel:+919901383998">+98-990-138-3998</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item border-0 py-3 rounded-4 mb-4">
                                        <h3 class="accordion-header" id="heading3">
                                            <button
                                                ...
                                                aria-expanded="false" aria-controls="collapse3"> استاد پروژه </button>
                                        </h3>
                                        <div id="collapse3" class="accordion-collapse border-0 collapse"
                                            aria-labelledby="heading3" data-bs-parent="#accordion">
                                            <div class="accordion-body pt-0 text-muted">مهندس حامد ایزدپناه</div>
                                        </div>
                                    </div>
                                    <div class="accordion-item border-0 py-3 rounded-4 mb-4">
                                        <h3 class="accordion-header" id="heading2">
                                            <button
                                                ...
                                                aria-expanded="false" aria-controls="collapse2"> این سایت چه کار می کند؟
                                            </button>
                                        </h3>
                                        <div id="collapse2" class="accordion-collapse border-0 collapse"
                                            aria-labelledby="heading2" data-bs-parent="#accordion">
                                            <div class="accordion-body pt-0 text-muted">این سایت بستری را برای خرید و
                                                فروش فایل های لایه باز ایجاد می کند.</div>
                                        </div>
                                    </div>
